...
@property (weak, nonatomic) IBOutlet UITextField *textFieldWriteData;
...
- (void)viewDidLoad {
    ...
    _textFieldWriteData.delegate = self;
}
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    _textFieldWriteData.text = self.settings.writeData;
...
- (BOOL)textFieldShouldReturn:(UITextField *)textField {
    ...
    switch (textField.tag) {
        ...
        case 1: // Length
            ...
            break;
        case 2: // WriteData
            self.settings.writeData = [NSString stringWithString:textField.text];
            break;
        default:
            break;
    }
