//
//  BarcodeScanDeviceViewController.m
//  BarcodeScan
//
...
#import <TSS_SDK.h>
#import "BarcodeScanDeviceViewController.h"

#define LOG(fmt, ...) NSLog((@"%s [%d] " fmt), __PRETTY_FUNCTION__, __LINE__, ##__VA_ARGS__);

@interface BarcodeScanDeviceViewController () <DOTRDelegateProtocol, UITableViewDataSource, UITableViewDelegate, ReaderDelegate>
...
@implementation BarcodeScanDeviceViewController
